...
if arches[0].startswith("SFNN"):
    ...
    # Keep the existing V2 suffix as an alias for nine king-rank stacks.
    is_v2 = layer_stack_spec == "V2"
    if is_v2:
        layer_stack_spec = "K3K3"
...
if SFNN:
    ...
    enable_common_shard_sfnn_accumulator_propagate = (
        not is_v2 and sfnn_common_shard and group_count % 2 == 0 and group_input_dims % 64 == 0
    )
    ...
    structure_string = (
        f"SFNN-{layers[0]}-V2" if is_v2 else
        "SFNN-1536"
